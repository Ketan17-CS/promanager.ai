...
export default function ProjectIdPage() {
    ...
    const inCompletedTodosByProject = useQuery(api.todos.getInCompleteTodosByProjectId, {
        projectId,
    }) ?? [];
    const completedTodosByProject = useQuery(api.todos.getCompletedTodosByProjectId, {
        projectId,
    }) ?? [];
                    ...
                    <div className="xl:px-40">
                        ...
                        <div className="flex flex-col gap-1 mt-4">
                            ...
                            <div className="flex items-center space-x-4 gap-2 border-b-2 p-2 border-gray-100 text-sm text-foreground/80">
                                ...
                                <CompletedTodos totalTodos={Array.isArray(projectTodosTotal) ? projectTodosTotal.length : projectTodosTotal} />
                            </div>
                        </div>
                    </div>
                </main>
