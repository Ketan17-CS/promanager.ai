...
import { CalendarIcon, Link, Text } from "lucide-react"
...
export default function AddTaskInline({
    ...
    const projectId = myProjectId || parentTask?.projectId || GET_STARTED_PROJECT_ID as
        Id<"projects">;
    const labelId = parentTask?.labelId || "q9787prmpphkna82kkg2tgc9yh6z2q1w" as
        Id<"labels">;
    ...
    // impliment after ai ingration problem solves. 
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        if (projectId) {
            if (parentId) {
                ...
                // await createTodoEmbeddings({ taskName: "buy a toy" }) 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <Select onValueChange={field.onChange}
                                        ...
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Set a Label" />
                                            </SelectTrigger>
                                        </FormControl>
                                        <SelectContent>
